...
// Types
type QuestionType = 'multiple-choice' | 'checkbox' | 'true-false';
...
export const NewCoursePage = () => {
	...
	const getQuestionsForLesson = (lessonId: string) => {
		return course.questions.filter(question => question.lessonId === lessonId);
	};
					...
					<nav className="flex items-center justify-between">
						<div className="flex items-center gap-2">
							<div className="relative h-8 w-8">
								<div className="absolute inset-0 rounded-md bg-[#FF5500] opacity-20 blur-sm"></div>
						...
						<div className="flex items-center gap-3">
							...
							<Button className="bg-[#FF5500] text-white hover:bg-[#FF5500]/90">
								Join Now
							</Button>
						</div>
					</nav>
									...
									<CardContent>
										{course.lessons.length > 0 ? (
											...
											<div className="py-8 text-center">
												...
												<p className="text-[#ABABAB]">
													Add lessons first, then create questions for each
													lesson
												</p>
											</div>
										)}
												...
												<div className="flex items-start">
													...
													<div>
														...
														<p className="text-sm text-[#ABABAB]">
															It's recommended to complete the following course
															first:
														</p>
														<Link
